    ...
    >
      ...
      >
        <Link href='https://github.com/GabrielMartinez26092005' isExternal>
          <Icon as={FaGithub} color={'black'} fontSize={['20px', '35px', '40px', '50px']} />
        </Link>
        <Link href='https://www.linkedin.com/in/gabriel-martinez-a49540319/' isExternal>
          <Icon as={FaLinkedin} color={'black'} fontSize={['20px', '35px', '40px', '50px']} />
        </Link>
        <Link href='https://www.instagram.com/gaabi_26/' isExternal>
          <Icon as={FaInstagram} color={'black'} fontSize={['20px', '35px', '40px', '50px']} />
        </Link>
      </Stack>
    </Box>
  );
