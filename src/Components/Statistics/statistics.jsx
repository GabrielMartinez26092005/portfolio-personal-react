  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Heading 
            fontSize={{ base: '15px', xl: '30px', '2xl': '35px' }}
          >
          ...
          >
            <CardStatistic numero='10+' descripcion='Proyectos Completados' />
            <CardStatistic numero='3+' descripcion='Cursos Completados' />
            <CardStatistic numero='5+' descripcion='Lenguajes de Programación' />
            <CardStatistic numero='8+' descripcion='Tecnologías utilizadas' />
          </SimpleGrid>
        </Box>
