    ...
    >
      ...
      >
        <GridItem rowStart={1} rowEnd={2} colStart={1}>
          <Image src='workstation1.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
        <GridItem rowStart={2} rowEnd={3} colStart={1}>
          <Image src='workstation2.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
        <GridItem rowSpan={2} colStart={2}>
          <Image src='workstation3.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
        <GridItem rowStart={1} rowEnd={2} colStart={3}>
          <Image src='workstation4.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
        <GridItem rowStart={2} rowEnd={3} colStart={3}>
          <Image src='workstation5.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
        <GridItem rowSpan={2} colStart={4}>
          <Image src='workstation6.jpg' objectFit='cover' h='100%' w='100%' borderRadius='5%' />
        </GridItem>
      </Grid>
    </Box>
  );
